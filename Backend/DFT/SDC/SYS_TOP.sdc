...
# Created by write_sdc on Sun May 15 17:37:34 2022
...
create_clock [get_ports SCAN_CLK]  -period 200  -waveform {0 100}
...
set_clock_groups -asynchronous -name Functional Clocks -group [list [get_clocks UART_RX_CLK] [get_clocks UART_TX_CLK]] -group [list [get_clocks REF_CLK] [get_clocks ALU_CLK]] -group [get_clocks SCAN_CLK]
